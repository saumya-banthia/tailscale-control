...
class Plugin:
    ...
    async def up(self, exit_node=False, node_ip='', allow_lan_access=True, login_server='https://controlplane.tailscale.com', operator='deck'):
        """
        ...
        try:
            ...
            cmd_list.append(f"--operator={operator}")
